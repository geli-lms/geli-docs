define({ "api": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Config name (e.g. imprint).</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "get",
    "url": "/api/courses/:id",
    "title": "Request course with certain ID",
    "name": "GetCourse",
    "group": "Course",
    "parameter": {
      "fields": {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "course",
            "description": "<p>Enrolled course.</p>"
          }
        ]
      },
      "examples": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "course",
            "description": "<p>Updated course.</p>"
          }
        ]
      },
      "examples": [
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "TypeError",
            "description": "<p>Wrong type allowed are just csv files.</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "BadRequestError",
            "description": "<p>You can't revoke your own privileges.</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "ForbiddenError",
            "description": "<p>Only users with admin privileges can change roles.</p>"
          }
        ]
      }
    },
